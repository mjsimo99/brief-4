            ...
            <div class="col-md-4 p-5 shadow-sm border ">
                <form class="form_login">
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control border border-primary" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Club name">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Logo du Club:</label>
                        <input type="file" class="form-control border border-primary" id="exampleInputPassword1" placeholder="Club logo">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Club Logo:</label>
                        <input type="date" class="form-control border border-primary" id="exampleInputPassword1" placeholder="Date">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Club Description:</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Club Discription..."></textarea>
                    </div>
                    <div class="d-grid">
